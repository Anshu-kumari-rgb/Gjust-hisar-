...
// Home page (UI)
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, 'nation_builder_mysql.html'));
});

// Direct access to the single-file UI (useful for refresh/links)
app.get('/nation_builder_mysql.html', (req, res) => {
  res.sendFile(path.join(__dirname, 'nation_builder_mysql.html'));
});
